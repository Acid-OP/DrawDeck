...
import { AlertCircle, User, Loader2, X } from "lucide-react";
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-2 sm:p-4 md:p-6">
      ...
      >
        ...
        <div className="text-center">
          ...
          >
            {provider} authentication is temporarily unavailable. Please use Google to sign in for now.
          </p>
      ...
      >
        <div className="text-center mb-4 sm:mb-6">
          ...
          <h2
            ...
            style={{
              color: isDark ? "#ced4da" : "#363c41",
              fontFamily: "Virgil, Comic Sans MS, cursive, Arial, sans-serif",
            }}
          >
            Welcome back!
          </h2>
